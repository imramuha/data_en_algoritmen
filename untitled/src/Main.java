...
class Main
{
    ...
    int BelmanFord(Main graaf,int oorsprong)
    {
        ...
        //System.out.println(dist[oorsprong]);
        ...
        for (int i=1; i<aantalKnopen; ++i)
        {
            for (int j=0; j< aantalVerbindingen; ++j)
            {
                ...
                System.out.println(dist[startpunt-1]+gewicht < dist[eindpunt-1]);

                // er wordt steeds gekeken of de score van A naar B lager is dan via de voorgaande weg
                //if (dist[startpunt-1]!=Integer.MAX_VALUE && dist[startpunt-1]+gewicht<dist[eindpunt-1])
        ...
        for (int j=0; j<aantalVerbindingen; ++j)
        {
            ...
            //System.out.println("a:" +dist[startpunt-1]);
            //System.out.println("2:" +gewicht);
            //System.out.println("3:" +dist[eindpunt-1]);
